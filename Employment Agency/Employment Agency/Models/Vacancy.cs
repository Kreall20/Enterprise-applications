...
public partial class Vacancy
{
    ...
    public virtual ICollection<ApplicantToVacancy> ApplicantToVacancies { get; set; } = new List<ApplicantToVacancy>();
    ...
    public virtual ICollection<VacancyLanguage> VacancyLanguages { get; set; } = new List<VacancyLanguage>();
}
